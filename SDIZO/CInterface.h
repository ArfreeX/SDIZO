...
//		gotoxy(10 + x, 3 + h);
//		std::cout << "Srednia wartosc elementow";
//		gotoxy(10 + x, 4 + h);
//		std::cout << "Suma elementow";
//		gotoxy(10 + x, 5 + h);
//		std::cout << "Blad sredniokwadratowy";
//		gotoxy(10 + x, 6 + h);
//		std::cout << "Najwieksza wartosc";
//		gotoxy(10 + x, 7 + h);
//		std::cout << "Najmniejsza wartosc";
//		gotoxy(10 + x, 8 + h);
//		std::cout << "Liczenie elementow";
//		gotoxy(10 + x, 9 + h);
//		std::cout << "Powrot";
//		while (wykonujPetle)
//		{
